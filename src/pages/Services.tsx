...
const services = [
  {
    ...
    pricing: [
      { route: "AIBD Airport ↔ Dakar", price: "35,000 - 45,000 FCFA" },
      { route: "AIBD Airport ↔ Saly", price: "45,000 - 55,000 FCFA" },
      { route: "AIBD Airport ↔ Lac Rose", price: "40,000 - 50,000 FCFA" },
    ],
  },
  {
    id: "daily",
    ...
    pricing: [
      { route: "Base Package (8h / 200km)", price: "55,000 - 95,000 FCFA" },
      { route: "Overtime", price: "5,000 FCFA/hour" },
      { route: "Extra kilometers", price: "300 FCFA/km" },
    ],
  },
  {
    id: "tours",
    ...
    pricing: [
      { route: "Gorée Island + Dakar Tour", price: "75,000 FCFA" },
      { route: "Lac Rose Discovery", price: "65,000 FCFA" },
      { route: "Multi-day Circuits", price: "From 150,000 FCFA/day" },
    ],
  },
  {
    id: "events",
    ...
    pricing: [
      { route: "Wedding Package (4h)", price: "80,000 - 120,000 FCFA" },
      { route: "Baptism / Family Events", price: "55,000 - 85,000 FCFA" },
      { route: "Full-day Event", price: "Custom Quote" },
    ],
  },
  {
    id: "corporate",
    ...
    pricing: [
      { route: "Delegation Transfer", price: "Custom Quote" },
      { route: "Seminar Shuttles", price: "From 65,000 FCFA/day" },
      { route: "Monthly Rental", price: "Contact Us" },
    ],
  },
];
...
const terms = {
  reservation: [
    "Deposit: 30% to confirm the service",
    "Balance: Payment at end of service to driver",
    "Methods: Cash, Mobile Money, Bank Transfer",
  ],
  cancellation: [
    "Cancellation > 48h: Full deposit refund",
    "Cancellation 24-48h: 50% deposit refund",
    "Cancellation < 24h: Deposit non-refundable",
    "Modification: Free, subject to availability",
  ],
  client: [
    "Respect agreed itinerary",
    "Advance notice for stops",
    "Vehicle respect (damages will be charged)",
  ],
  commitment: [
    "Punctuality: Vehicle present at agreed time/place",
    "Cleanliness & Comfort: Clean vehicle, optimal fuel/AC",
    "Safety: Professional driver, perfect vehicle condition",
    "Flexibility: Adapt to reasonable unforeseen events",
  ],
};
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              ...
              <ul className="space-y-2">
                {terms.commitment.map((item) => (
                  <li key={item} className="flex items-start gap-2 text-secondary-foreground/80">
                    <CheckCircle className="w-4 h-4 text-primary mt-1 shrink-0" />
                    <span>{item}</span>
                  </li>
                ))}
